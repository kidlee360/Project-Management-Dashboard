...
"[project]/gemini-next-app/pages/api/tasks.ts [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function handler(req, res) {
    if (req.method === 'GET') {
        try {
            const userId = 1;
            const result = await __TURBOPACK__imported__module__$5b$project$5d2f$gemini$2d$next$2d$app$2f$lib$2f$db$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["default"].query('SELECT * FROM tasks WHERE user_id = $1 ORDER BY id ASC', [
                userId
            ]);
        ...
        try {
            ...
            const userId = 1;
            const result = await __TURBOPACK__imported__module__$5b$project$5d2f$gemini$2d$next$2d$app$2f$lib$2f$db$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["default"].query('INSERT INTO tasks (task, description, due_date, columnname, priority, user_id) VALUES ($1, $2, $3, $4, $5, $6) RETURNING *', [
                task,
                description,
                due_date,
                columnname,
        ...
        try {
            ...
            const userId = 1;
            const result = await __TURBOPACK__imported__module__$5b$project$5d2f$gemini$2d$next$2d$app$2f$lib$2f$db$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["default"].query('UPDATE tasks SET task = $1, description = $2, due_date = $3, columnname = $4, priority = $5 WHERE id = $6 RETURNING *', [
                task,
                description,
                due_date,
                columnname,
        ...
        try {
            ...
            const result = await __TURBOPACK__imported__module__$5b$project$5d2f$gemini$2d$next$2d$app$2f$lib$2f$db$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["default"].query('DELETE FROM tasks WHERE id = $1 AND user_id = $2 RETURNING id', [
                id,
                userId
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b3a99b60._.js.map