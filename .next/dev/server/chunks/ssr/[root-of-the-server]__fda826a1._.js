...
function DisplayCard(props) {
    ...
    // --- DND Kit Integration ---
    const { attributes, listeners, setNodeRef, transform, isDragging } = (0, __TURBOPACK__imported__module__$5b$externals$5d2f40$dnd$2d$kit$2f$core__$5b$external$5d$__$2840$dnd$2d$kit$2f$core$2c$__cjs$29$__["useDraggable"])({
        // 1. CRITICAL: The ID DND Kit uses to identify the dragged item
        id: id
    });
    // Transform style applies the card's movement during the drag
    const style = {
        transform: __TURBOPACK__imported__module__$5b$externals$5d2f40$dnd$2d$kit$2f$utilities__$5b$external$5d$__$2840$dnd$2d$kit$2f$utilities$2c$__cjs$29$__["CSS"].Translate.toString(transform),
        height: '300px'
    };
    (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useEffect"])(()=>{
        if (isDragging) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__fda826a1._.js.map