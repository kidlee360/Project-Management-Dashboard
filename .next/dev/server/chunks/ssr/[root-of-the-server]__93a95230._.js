...
function DisplayCard(props) {
    ...
    const handleTouchStart = (e)=>{
        ...
        console.log(sessionStorage.getItem("draggingTaskId")); //WORKING
    ...
    const handleTouchMove = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useCallback"])((e)=>{
        ...
        if (elementOver) {
            const dropZone = elementOver.closest('[data-column-name]');
            if (dropZone) {
                const columnName = dropZone.getAttribute('data-column-name');
                sessionStorage.setItem("dropTargetColumn", columnName || '');
                console.log(sessionStorage.getItem("dropTargetColumn")); //WORKING
            }
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__93a95230._.js.map